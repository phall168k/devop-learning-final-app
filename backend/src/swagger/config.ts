...
export const SWAGGER_TITLE = 'Final DevOp Learning';
export const SWAGGER_DESCRIPTION = 'Final DevOp Learning';
export const SWAGGER_VERSION = '1.0.0';
export const SWAGGER_SERVER = 'v1';
export const SWAGGER_SITE_TITLE = 'Final DevOp Learning';
